...
const Step1_Beneficiaries = ({
  ...
  const beneficiaryGroups = [
    ...
    },
    {
      ...
      label: "คนในพื้นที่",
      iconSrc:
        "https://cdn.builder.io/api/v1/image/assets%2F0eb7afe56fd645b8b4ca090471cef081%2Fd0e13c552a39418eb25993c7d87905c8?format=webp&width=100",
    },
    {
      id: "elderly",
      label: "ผู้สูงอายุ",
  ...
  return (
    <FigmaStyle1Layout
      ...
      className="ask04-page mn2-step1-page figma-style1-ukpack1 fake-news-page"
      imageLoading="eager"
