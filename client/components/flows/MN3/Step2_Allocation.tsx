      ...
      <div className="app-container py-8 animate-fade-in-up">
        ...
        <div className="budget-display-white">
          <div className="budget-item text-black">
            งบทั้งหมด:{" "}
            <span className="text-primary-action">{totalBudget}</span>
          </div>
          <div
        ...
        {isOverBudget && (
          <div className="status-message error">
            ...
            กรุณาปรับลดจำนวนให้อยู่ในงบประมาณ {totalBudget} หน่วย
          </div>
        )}

        {remainingBudget > 0 && remainingBudget < totalBudget && (
          <div className="status-message warning">
            คุณยังมีงบประมาณเหลือ <strong>{remainingBudget} หน่วย</strong>{" "}
            กรุณาจัดสรรให้ครบ
          </div>
        )}
        ...
        <div className="progress-container">
          <div className="progress-dots">
            ...
            <div
              ...
              aria-label="ขั้นตอนที่ 4 กำลังดำเนินการ"
            ></div>
            <div
