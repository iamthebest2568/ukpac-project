...
const Step1_Choice = ({
  ...
  const handleNext = () => {
    ...
    const data = {
      budget_step1_choice: { top3BudgetChoices: selectedPriorities },
    };
    onNext(data);
  };
    ...
    <div className="theme-white min-h-screen">
      <div className="app-container py-8 animate-fade-in-up">
        ...
        <div className="selection-counter text-black">
          เลือกให้ครบ {maxSelections} ข้อ (เลือกแล้ว {selectedPriorities.length}
          /{maxSelections})
        </div>
        ...
        <div className="progress-container">
          <div className="progress-dots">
            ...
            <div
              ...
              aria-label="ขั้นตอนที่ 4"
            ></div>
            <div
              className="progress-dot inactive"
              aria-label="ขั���นตอนที่ 5"
            ></div>
          </div>
