...
const Step1_Choice = ({
  ...
  const priorityImageMap: { [key: string]: string } = {
    ...
    "เพิ่���ความถี่รถไฟฟ้า": "https://cdn.builder.io/api/v1/image/assets%2F0eb7afe56fd645b8b4ca090471cef081%2Fd90beaca642d4cceba685d933aeb644f?format=webp&width=720",
