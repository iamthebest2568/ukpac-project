...
interface BudgetStep2AllocationProps {
...
const BudgetStep2Allocation = ({ sessionID, onNavigate, journeyData }: BudgetStep2AllocationProps) => {
  ...
  const handleNext = () => {
    const data = { budgetAllocation, allocatedBudget, selectedPriorities };
    onNavigate('budget_step3_result', data);
  };
      ...
      <div className="app-container py-8 animate-fade-in-up">
        ...
        {isComplete && (
          <div className="status-message success">
            <strong>เยี่ยม!</strong> คุณจัดสรรงบประมาณครบ {totalBudget} หน่วยแล้��
          </div>
        )}
...
export default BudgetStep2Allocation;
