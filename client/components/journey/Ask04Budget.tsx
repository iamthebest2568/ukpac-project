        ...
        {journeyData && Object.keys(journeyData).length > 0 && (
          <div className="context-info">
            ...
            <div className="space-y-2 text-caption text-text-secondary">
              ...
              {journeyData.budget_step1_choice && (
                <p>• นโยบายที่เลือก: {journeyData.budget_step1_choice.top3BudgetChoices?.join(', ')}</p>
              )}
              {journeyData.budget_step2_allocation && (
                <p>• การจัดสรรงบประมาณ: รวม 100 หน่วย</p>
              )}
            </div>
          </div>
        )}
