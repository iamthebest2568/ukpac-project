...
export const BENEFICIARY_GROUPS = {
  ...
  'locals': { label: 'คนในพื้นที่', icon: '🏘️', description: 'ผู้ที่อาศัยในพื้นที่' },
  'elderly': { label: 'ผู้สูงอายุ', icon: '👴', description: 'ผู้สูงอายุ 60 ปีขึ้นไป' },
  'students': { label: 'นักเรียนนักศึกษา', icon: '🎓', description: 'นักเรียนและนักศึกษา' },
  'disabled': { label: 'คนพิการ', icon: '♿', description: 'ผู้พิการทุกประเภท' },
  'other': { label: 'อื่นๆ', icon: '❓', description: 'กลุ่มอื่นๆ ที่เฉพาะเจาะจง' }
} as const;
...
export const ARIA_LABELS = {
  ...
  PROGRESS_STEP_ACTIVE: (step: number) => `ขั้นตอนที่ ${step} กำลังดำเน���นการ`,
...
export const STATUS_MESSAGES = {
  SELECTION_REQUIRED: (min: number) => `กรุณาเลือกอย่างน้อย ${min} ข้อเพื่อดำเนินการต่อ`,
  SELECTION_COMPLETE: (count: number, max: number) => `เลือกให้ครบ ${max} ข้อ (เลือกแล้ว ${count}/${max})`,
  SELECTION_LIMIT_REACHED: (max: number) => `คุณเลือกครบจำนวนแล้ว หากต้องการเลือกข้อใหม่ กรุณายกเลิกการเลือกข้อใดข้อหนึ่งก่อน`,
  BUDGET_OVER_LIMIT: (total: number) => `งบประมาณเกินที่กำหนด! กรุณาปรับลดจำนวนให้อยู่ในงบประมาณ ${total} หน่วย`,
  BUDGET_REMAINING: (remaining: number) => `คุณยังมีงบประมาณเห���ือ ${remaining} หน่วย กรุณาจัดสรรให้ครบ`,
  BUDGET_COMPLETE: (total: number) => `เยี่ยม! คุณจัดสรรงบประมาณครบ ${total} หน่วยแล้ว`,
  INPUT_REQUIRED: 'กรุณากรอกข้อความเพื่อดำเนินการต่อ',
  ACCESSIBILITY_INFO: 'แบบสำรวจนี้รองรับการใช้งานผ่านแป้นพิมพ์และโปรแกรมอ่านหน้าจอ'
} as const;
