...
const VideoIntroPageFixed = () => {
  ...
  const storyData: StoryData = {
    ...
    SCENE_PROFILE: {
      ...
      choices: [
        {
          text: "ผู้ท���่ต้องเข้าเมืองทำงาน",
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "profile", value: "commuter" },
            destination: "SCENE_GENDER",
          },
        },
        {
          ...
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "profile", value: "resident" },
            destination: "SCENE_GENDER",
          },
        },
        {
          text: "นักศึกษาที่มาเรียนในพื้นที่",
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "profile", value: "student" },
            destination: "SCENE_GENDER",
          },
        },
        {
          text: "ผู้ประกอบการที่มาขายของ",
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "profile", value: "vendor" },
            destination: "SCENE_GENDER",
          },
        },
        {
          text: "ผู้ปกครองที่มารับ-ส่งลูก",
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "profile", value: "parent" },
            destination: "SCENE_GENDER",
          },
        },
        {
          text: "ผู้มาจับจ่ายซื้อของ",
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "profile", value: "shopper" },
            destination: "SCENE_GENDER",
          },
        },
      ],
      ...
      choices: [
        {
          ...
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "gender", value: "male" },
            destination: "SCENE_STATUS",
          },
        },
        {
          text: "หญิง",
      ...
      choices: [
        {
          ...
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "status", value: "disabled" },
            destination: "SCENE_FREQUENCY",
          },
        },
        {
          text: "เด็ก",
    ...
    SCENE_ATTITUDE_CHECK: {
      ...
      choices: [
        {
          text: "ไม่เชื่อว่าจะได้ผล",
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "initial_attitude", value: "wont_work" },
            destination: "SCENE_POLICY_QNA",
          },
        },
        {
          text: "กลัวเป็นภาระทางการเงิน",
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "initial_attitude", value: "financial_burden" },
            destination: "SCENE_POLICY_QNA",
          },
        },
        {
          text: "ไม่อยากเปลี่ยนวิธีเดินทาง",
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "initial_attitude", value: "unwilling_to_change" },
            destination: "SCENE_POLICY_QNA",
          },
        },
        {
          text: "ลองดู ถ้าไม่ทำอะไร ปัญหาก็ไม่หาย",
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "initial_attitude", value: "positive" },
            destination: "SCENE_POLICY_QNA",
          },
        },
      ],
      ...
      choices: [
        {
          ...
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "reaction", value: "watched" },
            destination: "SCENE_PERSUASION",
          },
        },
        {
          ...
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "reaction", value: "curious" },
            destination: "SCENE_PERSUASION",
          },
        },
        {
          ...
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "reaction", value: "not_watched" },
            destination: "SCENE_PERSUASION",
          },
        },
      ],
      ...
      choices: [
        {
          ...
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "final_stance", value: "agree" },
            destination: "EXIT_TO_SURVEY",
          },
        },
        {
          text: "กลางๆ",
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "final_stance", value: "neutral" },
            destination: "EXIT_TO_SURVEY",
          },
        },
        {
          ...
          action: {
            type: "LOG_AND_NAVIGATE",
            log: { key: "final_stance", value: "disagree" },
            destination: "EXIT_TO_SURVEY",
          },
        },
      ],
      ...
      try {
        ...
        setLoadingError(
          error instanceof Error
            ? error.message
            : "Failed to initialize video system",
        );
        setIsLoading(false);
      }
    };
  ...
  const playSegment = useCallback(
    (start: number, end: number, opts: any = {}) => {
  ...
  const loadScene = useCallback(
    (sceneId: string) => {
      try {
        ...
        if (scene.type === "video") {
          lastVideoSegment.current = {
            start: scene.segment![0],
            end: scene.segment![1],
          };
          ...
          const currentChoices =
            choicesByProfile[profile] || choicesByProfile.default;
  ...
  const handleReplayClick = () => {
    try {
      ...
      hideAllOverlays();
      playSegment(
        lastVideoSegment.current.start,
        lastVideoSegment.current.end,
        {
          onceOnEnd: () => {
        ...
        {showStartOverlay && playerInitialized && (
          <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-end p-12 text-center text-white z-30">
            <h1 className="text-white font-bold text-3xl leading-tight mb-8 font-['Kanit']">
              <span className="text-white">แล้วถ้าหากวันหนึ่งมี</span>
              <br />
              <span className="text-[#EFBA31]">การเก็บค่าธรรมเนียม</span>
              <br />
              <span className="text-[#EFBA31]">เพื่อแก้ไขปัญหาจราจร</span>
              <br />
