                ...
                <Card title="หัวข้อข้อมูล (Topics)">
                  ...
                  >
                    ...
                    <AccordionItem value="mn2">
                      <AccordionTrigger>Minigame 2 : ค��่</AccordionTrigger>
                      <AccordionContent>
                        <ul className="space-y-1 text-sm">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "คุณคิดว่านโยบายปัจจุบัน ควรปรับเปลี่ยนประเด็นอะไรบ้าง (ลดค่าโดยสาร, ปรับปรุงคุณภาพ, ขึ้นราคา, เ���ิ่มขบวน, เพิ่มความถี่ ฯลฯ)",
                      ...
                      "ตอนนี้มีข้อมูลที่ผิดพลาด เช่น ข่าวปลอมเกี่ย��กับ��โยบาย คุณคิดว่าอย่างไร",
