          ...
          {stats && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <Card title="แนวโน���มการเล่น (รายวัน)">
                ...
                <Card title="หัวข้อข้อมูล (Topics)">
                  ...
                  >
                    ...
                    <AccordionItem value="stornaway">
                      <AccordionTrigger>
                        เมื่อได้ยินข��าวนี้ คุณคิดยังไง
                      </AccordionTrigger>
                      <AccordionContent>
                        <ul className="space-y-1 text-sm">
                    ...
                    <AccordionItem value="reward">
                      <AccordionTrigger>ลุ้��รางวัล</AccordionTrigger>
                      <AccordionContent>
                        <ul className="space-y-1 text-sm">
                          <li className="flex justify-between">
                            <span>เข้าร่วม</span>
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "คุณคิดว่านโยบาปัจจุบัน ควรปรับเปลี่ยนประเด็นอะไรบาง (ลดค่าโดยสาร, ปรับปรุงคุณภาพ, ขึ้นราคา, เพิ่มขบวน, เพิ่มความ��ี่ ฯลฯ)",
                      ...
                      "ตอนนี้มีข้อมูลที่ผิดพลาด เช่น ข่าวปลอมเกี่ยวกับนโยบาย คุณคิดว่า���ย่างไร",
