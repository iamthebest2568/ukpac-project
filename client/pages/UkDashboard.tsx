                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "บอกเราหน่อยว่าคุณเดินทางเข้าเมื���งด้วยวิธีการใดบ่อยที่สุด",
                      "จากนโยบายที่คุณ��ังเมื่อสักครู่ คุณมีความคิดเห็นอย่างไร",
                      ...
                      "คุณพอใจกับผลัพธ์���ี่เกิดขึ้นหรือไม่ (พอใจ / ไม่พอใจ)",
                      "คุณคิดว��ารัฐควรทำอะไรที่จะทำให้นโยบายนี้เกิดขึ้นได้จริง และเป็นประโยชน์ต่อประชาชนอย่างแท้จริง",
                      ...
                      "Time Stamp (First)",
                      "แชร์ให้เพื่���นไหม (ครั้งแรก)",
                      "Time Stamp (Last)",
                      "แชร์ให้���พื่อนไหม (เคยแชร์ไหม)",
                      "Session ID",
                    ]);
