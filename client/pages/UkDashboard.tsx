...
type SessionSummary = {
  ...
  mn3BudgetAllocation?: Record<string, number>; // ก��รจัดสรรงบประมาณ
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "คุณคิดว่านโยบายปัจจุบัน ควรปรับเปลี่ยนประเด็นอะไรบาง (ลดค่าโดยสาร, ปรับปรุงคุณภาพ, ขึ้นร���คา, เพิ่มขบวน, เพิ่มความถี่ ฯลฯ)",
                      ...
                      "ตอนนี้มีข้อมูลที่ผิ��พลาด เช่น ข่าวปลอมเกี่ยวกับนโยบาย คุณคิดว่าอย่างไร",
