...
type SessionSummary = {
  ...
  ask05Comment?: string; // ข้��เสนอเพิ่มเติมต่อรัฐ
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "คุณคิดว่านโยบายปัจจุบัน ควรปรับเปลี่ยนประเด็นอะไรบ้าง (ลดค่าโดยสาร, ปรับปรุงคุณภาพ, ขึ��นราคา, เพิ่มขบวน, ���พิ่มความถี่ ฯลฯ)",
                      "ค���ณคิดว่าใครควรได้รับการลดค่าโดยสารรถไฟฟ้า (ทุกคน, ผู้สูงอายุ, นักเรียน, คนทำงาน ฯลฯ)",
                      ...
                      "ตอนนี้มีข้อมูลที่ผิดพลาด เช่น ข่าวปลอมเก���่ยวกับนโย���าย คุณคิดว่าอย่างไร",
