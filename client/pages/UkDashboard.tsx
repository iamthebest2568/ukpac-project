                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "จากข้อความข้างต้น ุณมีความคิดเห็นอยางไร (เห็นด้วย/กลางๆ/ไม่เห็นด้วย)",
                      ...
                      "คุณคิดว่านโยบาปัจจุบัน ควรปรับเปลี่ยนประเด็นอะไรบาง (ลดค่าโดยสาร, ปรับปรุงคุณ��าพ, ขึ้นราคา, เพิ่มขบวน, เพิ่มความถี่ ฯลฯ)",
                      "คุณคิดว่าใครควรไดรับการลดค่าโดยสรรถไฟฟ้าบ้าง (ทุกคน, ผู้สูงอายุ, นักเรียน, คนทำงาน ฯลฯ)",
                      ...
                      "คุณคิดว่ารัฐควรทำอะไรที่จะทำให้นโยบายนี้เกิดขึ้นได้จริง และเป็นประ��ยชน์ต่อประชาชนอย่างแท้จริง",
                      "ตอนนี้มีข้อมูลที่ผิดพลาด เช่น ข่��วปลอมเกี่ยวกับนโยบาย คุณคิดว่าอย่างไร",
