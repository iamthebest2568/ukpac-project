...
type SessionSummary = {
  ...
  satisfactionLevel?: string; // ระดับความพึง��อใจ
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "คุณคิดว่านโยบายปัจจุบัน ควรปรับเปลี่ยนประเด็นอะไรบ้าง (ลดค่าโดยสาร, ปรับปรุงคุณภาพ, ขึ��นรา��า, เพิ่มขบวน, เพิ่มความถี่ ฯลฯ)",
