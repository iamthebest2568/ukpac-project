...
type SessionSummary = {
  ...
  mn2Selections?: Record<string, string[]>; // กลุ่มเป้าหมายที่ควรได้���ับสิทธิ์
        ...
        <div className="w-full px-3 sm:px-4 md:px-6 lg:px-8 py-4 space-y-5">
          ...
          {stats && (
            <div className="space-y-6">
              ...
              {journey && (
                <Card title="ห��วข้อข้อมูล (Topics)">
                  <Accordion
                    type="single"
                    collapsible
                    className="w-full"
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "คุณคิดว่านโยบายปัจจุบัน ควรปรับเปลี่ยนประเด็นอะไรบาง (ลดค่าโดยสาร, ปรับปรุงคุณภาพ, ขึ้นราคา, เพิ่มขบว��, เพิ่มความถี่ ฯลฯ)",
                      ...
                      "คุณพอใจกับผลล��พธ์ที่เกิดขึ้นหรือไม่ (พอใจ / ไม่พอใจ)",
