            ...
            <button
              ...
              onClick={() => {
                ...
                if (user.trim() === expectedUser && pw === expectedPassword) {
                  ...
                  setPwErr("ชื่อผู้ใช้หรือรหัสผ่านไม่ถูกต้อ���");
                }
              }}
            >
              เข้าสู่แดชบอร์ด
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "ทำไมคุณถึงคิดอย่างนั้น (นโยบายไม่ครอบคลุม / ���ก็บไปก็ไม่มีอะไรดีข���้น / อื่นๆ)",
                      ...
                      "ขอบคุณที่ร่วมเป็นส่วนหนึ่ง → ต้องการลุ้นรับ��างวัลหรือไม่",
