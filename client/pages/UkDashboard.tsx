...
export default function UkDashboard() {
  ...
  const exportMappedCsv = (items: any[]) => {
    if (!items || !items.length) {
      alert("ไม่มีข้อมูลส���หรับดาวน์โหลด");
      return;
    }
    ...
    const headers = [
      ...
      "แชร์_ครั้งสุ���ท้าย (share_last_ts)",
      "เวลาจบเกม (Exit_Time)",
    ];
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "คุณคิดว่านโยบายปัจจุบัน ควรปรับเป��ี่ยนประเด็นอะไรบ้าง (ลดค่าโดยสาร, ปรับปรุงคุณภาพ, ขึ้นราคา, เพิ่มขบวน, เพิ่มความถี่ ฯลฯ)",
                      ...
                      "คุณคิดว่ารัฐควรทำอะไรที่จะทำให้นโยบายนี้เกิดขึ้นได้จริง และเป็นประโยชน์ต่อประชาชนอย่างแท��จริง",
