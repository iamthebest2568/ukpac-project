...
type SessionSummary = {
  ...
  mn2Selections?: Record<string, string[]>; // กลุ่มเป้าหมายที่ควรได้รับส���ทธิ์
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "คุณคิดว่านโยบาย��ัจจุบัน ควรปรับเปลี่ยนประเด็นอะไรบาง (ลดค่าโดยสาร, ปรับปรุงคุณภาพ, ขึ้นราคา, เพิ่มขบวน, เพิ่มความถี่ ฯลฯ)",
                      "คุณคิดว่าใครควรได้รับการลดค่าโดยสา��รถไฟฟ้าบ้าง (ทุกคน, ผู้สูงอายุ, นักเรียน, คนทำงาน ฯลฯ)",
                      ...
                      "คุณจะติดตามข่าว หรือเชื่อจากแหล่ง��หนมากที่สุด",
