...
type SessionSummary = {
  ...
  fakeNewsResponse?: string; // การตอบสนอง��่อข่าวปลอม
...
export default function UkDashboard() {
  ...
  const exportMappedCsv = (items: any[]) => {
    ...
    a.href = url;
    a.download = `ukpack1_sessions_${filenameTimestampBangkok()}.csv`;
    a.click();
  ...
  async function clearData() {
    if (
      !window.confirm("ลบข้อมูลทั้งหมดในเซิร์ฟเวอร์? การกระทำนี้ย้อนกลับไม่ได��")
    ) {
      return;
    }
    try {
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "จากข้อความข้างต้น คุณมีค��ามคิดเห็นอย่างไร (เห็นด้วย/กลางๆ/ไม่เห็นด้วย)",
                      ...
                      "ค���ณคิดว่าใครควรไ���้รับการลดค่าโดยสารรถไฟฟ้า (ทุกคน, ผู้สูงอายุ, นักเรียน, คนทำงาน ฯลฯ)",
                      "คุณคิดว่าควรใช้เง���นที่ได้จากการเก็บไปพัฒนาอะไร ก่อน 3 อันดับแรก",
                      ...
                      "คุณจะติดตามข่า��หรือเชื่อจากแหล่งไหนมากที่สุด",
