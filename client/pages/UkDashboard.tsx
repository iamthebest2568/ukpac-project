...
type SessionSummary = {
  ...
  ask05Comment?: string; // ข้อ���สนอเพิ่มเติมต่อรัฐ
...
export default function UkDashboard() {
  ...
  async function clearData() {
    if (
      !window.confirm("ลบข้อ��ูลทั้งหมดในเซิร์ฟเวอร์? การกระทำนี้ย้อนกลับไม่ได้")
    ) {
      return;
    }
    try {
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            ...
            <div className="flex flex-wrap items-end gap-3">
              ...
              <button
                ...
                onClick={clearData}
                disabled={clearing}
                title="ลบ events.jsonl และ app-events.jsonl บนเซิร���ฟเวอร์"
              >
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "ตอนนี้มี���้อ��ูลที่ผ��ดพลาด เช่น ข่าวปลอมเกี่ยวกับนโยบาย คุณคิดว่าอย่างไร",
