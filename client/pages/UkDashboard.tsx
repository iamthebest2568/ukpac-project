...
type SessionSummary = {
  ...
  mn3BudgetAllocation?: Record<string, number>; // การจัดสรรงบป���ะมาณ
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "คุณคิดว่าน���ยบายปัจจุบัน ควรปรับเปลี่ยนป���ะเด็นอะไรบาง (ลดค่าโดยสา��, ปรับปรุงคุณภาพ, ขึ้น���าคา, เพ��่มขบวน, เพิ่มความถี่ ฯลฯ)",
                      ...
                      "คุณคิดว่ารัฐควรทำอะไรที่จะทำให้นโยบายนี้เกิดขึ้นได้จริง และเป็นประโยชน์ต่อประชา���นอย่างแท้จริง",
