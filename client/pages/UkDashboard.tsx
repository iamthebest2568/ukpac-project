...
export default function UkDashboard() {
  ...
  const exportMappedCsv = (items: any[]) => {
    ...
    const headers = [
      ...
      "แ���ร์_ครั้งสุดท้าย (share_last_ts)",
      "เวลาจบเกม (Exit_Time)",
    ];
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "คุณคิดว่านโยบาย��ัจจุบัน ควรปรับเปลี่ยนประเด็นอะไรบ้าง (ลดค่าโดยสาร, ปรับปรุงคุณภาพ, ขึ��นราคา, เพิ่มขบวน, เพิ่มความถี่ ฯลฯ)",
                      ...
                      "คุณคิดว่ารัฐควรทำอะไรที่จะทำให้นโยบายนี้เกิดขึ้นได้จริง และเป็นประโยชน์ต���อประชาชนอย่างแท้จริง",
