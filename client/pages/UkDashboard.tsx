...
export default function UkDashboard() {
  ...
  async function clearData() {
    if (
      !window.confirm("ลบข้อมูลทั้งหมดในเซิร์ฟเวอร์? การกระ���ำนี้ย้อนกลับไม่ได้")
    ) {
      return;
    }
    try {
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "จากข้อควา��ข้างต้น คุณมีความคิดเห็นอย่างไร (เห็นด้วย/กลางๆ/ไม่เห็นด้วย)",
                      ...
                      "ค���ณจะติดตามข่าวหรือเชื่อจากแหล่งไหนมากที่สุด",
