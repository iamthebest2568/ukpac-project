                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "คุณใช้���ถแบบไหนเดินทางเข้าเมือง ?",
                      ...
                      "คุณคิดว่านโยบาปัจจุบัน ควรปรับเปลี่ยนประเด็นอะไ��บาง (ลดค่าโดยสาร, ปรับปรุงคุณภาพ, ขึ้นราคา, เพิ่มขบวน, เพิ่มความถี่ ฯลฯ)",
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <div className="text-lg font-medium">
                รายละเอ��ยดเซสชั: {detailSession?.slice(0, 12)}…
              </div>
              <button
