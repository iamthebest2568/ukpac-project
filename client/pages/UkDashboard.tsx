...
type SessionSummary = {
  ...
  fakeNewsResponse?: string; // การตอบสนองต่อข่าว��ลอม
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "จากข้อความข้างต้น คุณมีความคิดเห็นอ��่างไร (เห็นด้วย/กลางๆ/ไม่เห็นด้วย)",
                      ...
                      "ค���ณคิดว่าใครควรได้รับการลดค่า���ดยสารรถไฟฟ้า (ทุกคน, ผู้สูงอายุ, นักเรียน, คนทำงาน ฯลฯ)",
                      ...
                      "คุณจะติดตามข่าวหรือเชื่อจาก��หล่งไหนมากที่สุด",
