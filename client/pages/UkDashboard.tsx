                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "คุณคิดว่านโยบายปัจจุบัน ควรปรับเปลี่ยนประเด็นอะไรบ้าง (ลดค่าโ��ยสาร, ปรับปรุงคุณภาพ, ขึ้นราคา, เพิ่มขบวน, เพิ่มความถี่ ฯลฯ)",
                      ...
                      "ตอนนี้มีข้อมูลที��ผิดพลาด เช่น ข่าวปลอมเกี่ยวกับนโยบาย คุณคิดว่าอย่างไร",
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <div className="text-lg font-medium">
                ������ยละเอียดเซสชั: {detailSession?.slice(0, 12)}…
              </div>
              <button
