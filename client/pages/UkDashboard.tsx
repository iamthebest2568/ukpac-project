                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "คุณคิดว่านโยบายปัจจุบัน ควรปรับเปลี่ยนประ��ด็นอะไรบาง (ลดค่าโดยสาร, ปรับ��รุงคุณภาพ, ขึ้นราคา, เพิ่มขบวน, เพิ่มความถี่ ฯลฯ)",
                      ...
                      "ตอนนี้มีข้อมูลที่ผิดพล���ด เช่น ข่าวปลอมเกี่ยวกับนโยบาย คุณคิดว่าอย่างไร",
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <div className="text-lg font-medium">
                รายละเอียดเ���สชัน: {detailSession?.slice(0, 12)}…
              </div>
              <button
