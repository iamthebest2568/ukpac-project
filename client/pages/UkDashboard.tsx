...
type SessionSummary = {
  ...
  mn3BudgetAllocation?: Record<string, number>; // การจ���ดสรรงบประมาณ
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "คุณคิดว่าใครควรได้รับการลดค่���โดยสารรถไฟฟ้าบ้าง (ทุกคน, ผู้สูงอายุ, นักเรียน, คนทำงาน ฯลฯ)",
                      ...
                      "คุณจะติดตามข่าว หรือเชื่อจาก���หล่งไหนมากที่สุด",
                    ...
                    const perRows = sessions.map((s) => {
                      ...
                      return [
                        ...
                        s.shareFirstTs || "",
                        s.lastSeen || "",
                        s.shareCount && s.shareCount > 0 ? "ใช่" : "ไ��่",
                        s.sessionId || "",
                      ];
                    });
                    rows.push(...perRows);
