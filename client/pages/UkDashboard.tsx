...
type SessionSummary = {
  ...
  ask05Comment?: string; // ข้อเสนอ���พิ่มเติมต่อรัฐ
...
export default function UkDashboard() {
  ...
  async function clearData() {
    if (
      !window.confirm("ลบข้อมูลทั้งหมดใ��เซิร์ฟเวอร์? การกระทำนี้ย้อนกลับไม่ได้")
    ) {
      return;
    }
    try {
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "ตอนนี้มีข้อมูลที่ผิดพลาด เช่น ข่าวปลอมเก���่ยวกับนโยบาย คุณคิดว��าอย่างไร",
