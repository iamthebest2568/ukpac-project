...
export default function UkDashboard() {
  ...
  const exportMappedCsv = (items: any[]) => {
    ...
    const headers = [
      ...
      "���ชร์_ครั้งสุดท้าย (share_last_ts)",
      "เวลาจบเกม (Exit_Time)",
    ];
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "คุณคิดว่าน���ยบ��ยปัจจุบัน ควรปรับเปลี่ยนประเด็นอะไรบาง (ลดค่าโดยสา��, ปรับปรุงคุณภาพ, ขึ้น���าคา, เพ��่มขบวน, เพิ่มความถี่ ฯลฯ)",
                      ...
                      "คุณคิดว่ารัฐควรทำอะไรที่จะทำให้นโยบายนี้เกิดขึ้นได้จร��ง และเป็นประโยชน์ต่อประชาชนอย่างแท้จริง",
