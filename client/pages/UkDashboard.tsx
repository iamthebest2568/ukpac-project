...
type SessionSummary = {
  ...
  mn3BudgetAllocation?: Record<string, number>; // การจัดสรรงบประ���าณ
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "จากข้อความข้างต้น ุณมีความคิดเห็นอยางไร (เห็นด้วย/กลางๆ/ไ��่เห็นด้วย)",
                      ...
                      "คุณคิดว่าใครควรไดรับการลดค่าโดยสรรถไฟฟ้าบ้าง (ทุกคน, ผู้สู���อายุ, นักเรียน, คนทำงาน ฯลฯ)",
