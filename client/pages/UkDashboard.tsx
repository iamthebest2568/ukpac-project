...
export default function UkDashboard() {
  ...
  async function load() {
    ...
    try {
      ...
      setError(e?.message || "โหลดข้อ��ูลล��มเหลว");
    } finally {
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "บอกเราหน่อยว่าคุณเดินทางเข้าเมืองด้วยวิธีการใดบ่อยที่��ุด",
                      ...
                      "คุณพอใจ��ับผลลัพธ์ที่เกิดขึ้น��รือไ��่ (พ���ใจ / ไม่พอใจ)",
