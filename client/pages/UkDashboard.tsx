...
type SessionSummary = {
  ...
  satisfactionLevel?: string; // ระดับความ���ึงพอใจ
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    rows.push([
                      ...
                      "ทำไมคุณถึงคิด��ย่างนั้น (นโยบายไม่ครอบคลุม / เก็บไปก็ไม่มีอะไรดีขึ้น / อืนๆ)",
                      ...
                      "ขอบคุณที่ร่วมเป็นส่วนหนึ่ง → ต้องการลุ้���รับรางวัลหรือไม่",
