    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4">
        ...
        <div className="mt-3 text-sm text-gray-700">
          <p className="mb-3 font-semibold">ประกาศความเป็นส่วนตัว (PDPA)</p>

          <p className="mb-3">เกมนี้จะเก็บข้อมูลพฤติกรรมการเล่นและ ที่อยู่ IP ของอุปกรณ์
          เพื่อใช้ในการ วิเคราะห์ พัฒนา และสรุปผลความคิดเห็นในภาพรวมของผู้เล่น</p>

          <p className="mb-3">ข้อมูลที่เก็บจะถูก จัดเก็บอย่างปลอดภัย นำมาใช้เฉพาะภาพรวม และไม่สามารถระบุตัวตนได้ โดยข้อ���ูลจะถูกเก็บ ไม่เกิน 2 ปี หรือจนกว่าจะเสร็จสิ้นกระบวนการวิเคราะห์</p>
          ...
          ตาม พระราชบัญญัติคุมครองข้อมูลส่วนบุคคล พ.ศ. 2562</p>
