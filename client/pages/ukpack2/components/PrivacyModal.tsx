    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4">
        ...
        <div className="mt-3 text-sm text-gray-700">
          ...
          <p className="mb-3">หากท่านเข้า���่วมกิจกรรมลุ้นรับรางวัล จะมีการเก็บ ชื่อและเบอร์โทรศัพท์
          ...
          สามารถติดต่อได้ที่: บริษัท ทูลมอโร จำกัด<br/>อีเมล media.toolmorrow@gmail.com หรือ โทร 081-1667138</p>
        </div>
