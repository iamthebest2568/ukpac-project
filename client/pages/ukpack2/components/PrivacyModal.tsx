    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4">
        ...
        <div className="mt-3 text-sm text-gray-700">
          <p>
            เราเก็บข้อมูลบางอย่างเพื่อปรับปรุงประสบการณ์การใช้งาน เช่น
            ตัวเลือกการออกแบบที่คุณเลือก ข้อมูลนี้จะถูกใช้เพื่อ
            การวิจัยและพัฒนาเท่านั้น
            และจะไม่มีการเปิดเผยข้อมูลติดต่อของคุณโดยไม่ได้รับความยินยอมจากคุณ
          </p>
          <p className="mt-2">
