    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4">
        ...
        <div className="mt-3 text-sm text-gray-700 whitespace-pre-line">
          ...
          หากท่านเข้าร่วมกิจกรรมลุ้นรับรางวัล จะมีการเก็บ ชื่อแ���ะเบอร์โทรศัพท์
          เพื่อใช้ในการ ติดต่อและรับของรางวัลเท่านั้น
          โดยข้อมูลส่วนนี้จะถูกลบเมื่อกิจกรรมสิ้นสุด

          โดยการกด “เริ่มเกม” ถือว่าท่านยินยอมให้มีการเก็บและประมวลผลข้อมูลดังกล่าว
          ตาม พระราชบัญญัติคุมครองข้อมูลส่วนบุคคล พ.ศ. 2562

          หากต้องการสอบถามหรือลบข้อมูลของท่าน
          สามารถติดต่อได้ที่: บริษัท ทูมอโร จำกัด
