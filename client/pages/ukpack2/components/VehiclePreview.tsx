        ...
        >
          {showShadow && (
            <img
              ...
              src={SHADOW_URL}
              alt=""
              className="vehicle-shadow absolute pointer-events-none select-none"
              style={{ bottom: "8px" }}
              decoding="async"
              loading="eager"
              aria-hidden="true"
                ...
                return (
                  <div className="overlay-ribbon absolute left-1/2 transform -translate-x-1/2 -top-4 z-20 w-[110%] sm:w-[120%] md:w-[130%] lg:w-[140%] flex items-center justify-center">
                    ...
                    <button
                      ...
                      className="overlay-ribbon-next p-2 bg-white/80 rounded-full shadow-sm ml-2 text-[#003366]"
                    >
                      ›
                    </button>
                  </div>
