...
const PdpaScreen: React.FC = () => {
  ...
  return (
    <CustomizationScreen
      title="ประกา��ความเป็นส่วนตัว (PDPA)"
      theme="light"
      fullWidth
      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        <div className="prose prose-sm text-[#000d59] text-center mx-auto">
          <p>
            ...
            เพื่อใช้ในการ วิเคราะห์ พัฒนา และสรุปผลความคิดเห็นในภาพรวม���องผู้เล่น
          </p>
          ...
          <p>
            โดยการกด “เริ่มเกม”
            ถือว่าท่านยินยอมให้มีการ��ก็บและประมวลผลข้อ���ูลดังกล่าว ตาม
