...
const CHASSIS_LABELS: Record<string, string> = {
  small: "รถเมล์ขนาดเล��ก 16–30 ที่นั่ง",
            ...
            {selected === "small" ? (
              <div className="bg-[#e6e7e8] rounded-xl p-4 text-[#001a73] font-sarabun">
                ...
                <p>
                  ...
                  ค่าโดยสารถูกม���ก บางแห่งนั่งได้ทั้งสาย เพียง 100 เยน
              ...
              <div className="bg-[#e6e7e8] rounded-xl p-4 text-[#001a73] font-sarabun">
                ...
                <p>
                  ...
                  และ���่วยลดปัญหาสิ่งแวดล้อมไปพร้อมกัน
                </p>
              </div>
            ) : selected === "large" ? (
              <div className="bg-[#e6e7e8] rounded-xl p-4 text-[#001a73] font-sarabun">
              ...
              <div className="bg-[#e6e7e8] rounded-xl p-4 text-[#001a73] font-sarabun">
                ...
                <p>
                  ...
                  ทำให��ผู้สูงอายุและเด็กเข้าถึงบริการสำคัญ เช่น
