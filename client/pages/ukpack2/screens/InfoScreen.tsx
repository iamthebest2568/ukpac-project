  ...
  return (
    <>
            ...
            {selected === "small" ? (
              <div className="bg-[#e6e7e8] rounded-xl p-4 text-[#001a73] font-sarabun">
                ...
                <p>
                  ...
                  รถเมล์ขนาดเล็กที่วิ่งเข้าซอยและพื้นที่ ที่รถ��หญ่เข้าไม่ถึง
              ...
              <div className="bg-[#e6e7e8] rounded-xl p-4 text-[#001a73] font-sarabun">
                ...
                <p>
                  ...
                  ค่าโดยสารถูกมาก บางแห่งนั่งได้ทั้งสาย เพียง 100 เยน
                  ทำให้ผู้สูงอายุและเด็กเข้าถึงบริการสำคัญ เช่น
                  โรงพยาบาลและศูนย์ชุมชนได้สะดวกขึ���น
                </p>
              </div>
            )}
          </div>
      ...
      <ConfirmModal
        ...
        title="ออกจากหน้าจอ"
        message="คุณแน่ใจหรือไม่ว่าต้องการออก? การเปลี่ยนแปลงของคุณจะไม่ถูกบันทึ���"
        onConfirm={() => navigate("/")}
