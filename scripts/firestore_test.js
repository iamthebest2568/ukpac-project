// Simple test script to write a document to Firestore using service account env
// Usage: FIREBASE_SERVICE_ACCOUNT='{...}' FIREBASE_STORAGE_BUCKET='...' node scripts/firestore_test.js
